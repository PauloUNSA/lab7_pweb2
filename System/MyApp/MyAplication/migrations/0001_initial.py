# Generated by Django 4.2.2 on 2023-07-21 14:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='user_type_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MyAplication.user_type'),
        ),
        migrations.AddField(
            model_name='teacher',
            name='organization_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MyAplication.organization'),
        ),
        migrations.AddField(
            model_name='teacher',
            name='user_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MyAplication.user'),
        ),
        migrations.AddField(
            model_name='student',
            name='organization_id',
        ...
        migrations.AddField(
            model_name='student',
            name='school_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MyAplication.school'),
        ),
        migrations.AddField(
            model_name='student',
            name='user_id',
        ...
        migrations.AddField(
            model_name='group',
            name='assignment_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MyAplication.assignment'),
        ),
        migrations.AddField(
            model_name='group',
            name='organization_id',
        ...
        migrations.AddField(
            model_name='group',
            name='teacher_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MyAplication.teacher'),
        ),
        migrations.AddField(
            model_name='faculty',
            name='organization_id',
        ...
        migrations.AddField(
            model_name='enroll',
            name='group_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MyAplication.group'),
        ),
        migrations.AddField(
            model_name='enroll',
            name='organization_id',
        ...
        migrations.AddField(
            model_name='enroll',
            name='student_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MyAplication.student'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='academic_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MyAplication.academic'),
        ),
        migrations.AddField(
            model_name='assignment',
            name='course_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MyAplication.course'),
        ),
        migrations.AddField(
            model_name='assignment',
            name='organization_id',
        ...
        migrations.AddField(
            model_name='academic',
            name='department_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MyAplication.department'),
        ),
        migrations.AddField(
            model_name='academic',
            name='organization_id',
